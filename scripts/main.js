...
function tryName() {
    if (urlParams.has("r") && urlParams.has("an")) {
        ...
        if (allowed.includes(recallName())) {
            ...
            location.assign("./redirect.html?m=%3Cp%3EYou%20do%20not%20have%20access%20to%20this%20page.%3C/p%3E%3Cbutton%20onclick=%27window.close();leave()%27%3EOkay%3C/button%3E&C=gold&c=yellow&snail=0");
        }
    }
}
